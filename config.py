...
flags.DEFINE_string("data_path", "/home/sunquan/data/bpedata/cs/", "Where the training/test data is stored.")
flags.DEFINE_string("vocab_path", "/home/sunquan/data/bpedata/cs/", "Where the training/test data is stored.")
